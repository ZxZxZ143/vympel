                    ...
                    <div className="product-details-grid grid min-w-0 gap-10 pt-10 sm:pt-12 lg:grid-cols-[minmax(0,0.58fr)_minmax(20rem,0.42fr)] lg:gap-18">
                        ...
                        <ProductSpecs
                            ...
                            labels={{
                                ...
                                dialType: t("details.dialType"),
                                dialMarking: t("details.dialMarking"),
                                powerSource: t("details.watchPowerSource"),
                                strapColor: t("details.strapColor"),
                                dialColor: t("details.dialColor"),
                                packageContents: t("details.packageContents"),
                                watchFeatures: t("details.watchFeatures"),
