...
2026-08-02 - Enforced the exact six-brand/five-country catalog domain across the forward-only migration, backend validation, CRM derived fields, storefront routes/filters, tests, and local PostgreSQL/browser rehearsal; RC.11 publication evidence is recorded separately after the immutable release workflow completes.
