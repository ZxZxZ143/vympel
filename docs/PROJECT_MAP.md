...
2026-08-16 - Added CMS-managed About Instagram posts with strict canonical URL policy, ordered publish lifecycle, exact four-card fallback, and durable revalidation reuse; restricted carousel autoplay to an accessible reduced-motion-aware Home hero icon and removed large start/stop controls elsewhere.
