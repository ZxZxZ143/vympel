...
2026-07-27 - Added amd64/ARM64 OCI publication and runtime-proof architecture, bounded Oracle Ampere A1 staging support, and an explicit public-build contract in every production CRM CI build; external deployment remains pending.
