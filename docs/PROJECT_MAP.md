...
2026-07-22 - Added RC deployment/verification architecture, non-publishing automatic image evidence, and remote-CI portability corrections for concurrency, executable Gradle wrapper, and Windows/Ubuntu rehearsal command resolution.
