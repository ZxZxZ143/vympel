...
2026-07-26 - Added guarded GHCR publication architecture, remediated frontend advisories, made Compose commands shell-lint safe, and removed a race from the CMS retry rehearsal without weakening its terminal proof.
