...
2026-07-30 - Recorded the verified `v1.0.0-rc.9` three-image amd64/ARM64 GHCR publication, exact sslip.io frontend contract, registry digests, actual final Liquibase changeset, and explicit no-deployment boundary.
