...
2026-07-27 - Replaced QEMU image publication with pinned distributed native amd64/ARM64 builders, recorded the immutable incomplete RC.3 attempt, and retained QEMU only for post-publication runtime proof.
