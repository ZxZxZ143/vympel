...
2026-07-27 - Replaced QEMU image publication with pinned distributed native amd64/ARM64 builders, recorded incomplete RC.3, and made the finite Nginx startup health poll resilient to transient listener resets.
