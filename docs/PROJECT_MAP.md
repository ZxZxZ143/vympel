...
2026-08-25 - Added sanitizer-backed Markdown/rich-text product descriptions, a multilingual CRM Write/Preview toolbar editor, server-rendered storefront description slots, responsive Markdown design rules, focused persistence/security tests, and the pinned npm 10/Linux dependency verification contract without changing the backend or database API.
