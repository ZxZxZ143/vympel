...
2026-08-02 - Restored public-storefront navigation progress across localized links, query updates, imperative routers, and browser history with exact ignored-click rules, reduced-motion handling, finite cleanup, black 4px styling, and regression coverage; CRM remains unchanged.
