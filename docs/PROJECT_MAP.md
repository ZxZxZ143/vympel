...
2026-07-22 - Added RC deployment/verification architecture, non-publishing automatic image evidence, and remote-CI corrections for concurrency, executable modes, bounded upstream readiness, native command resolution, canonical build configuration, and Buildx export compatibility.
