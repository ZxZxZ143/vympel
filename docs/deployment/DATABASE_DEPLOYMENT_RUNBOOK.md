...
After migration, compare the expected/latest changeset (currently `2026-09-03-01-watch-product-characteristics`) and review migration logs for errors without copying credentials into evidence.
