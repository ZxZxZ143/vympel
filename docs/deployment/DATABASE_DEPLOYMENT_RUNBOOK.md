...
After migration, compare the expected/latest changeset (currently `2026-08-31-02-kaspi-product-source-links`) and review migration logs for errors without copying credentials into evidence.
